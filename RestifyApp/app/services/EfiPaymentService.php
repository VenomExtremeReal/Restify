...
class EfiPaymentService {
    ...
    private function simulatePixResponse($amount, $payerData) {
        $txid = $this->generateTxid();
        $pixCode = $this->generateSimulatedPixCode($amount, $payerData['name'], $txid);
        ...
        return [
            ...
            'qr_code' => $pixCode,
            'qr_code_url' => 'https://pix.sejaefi.com.br/pagar/df0b6157a14aff09f8c3c5d1e03bf03f8a0cbf4d.html',
            'amount' => $amount,
            'expires_at' => date('Y-m-d H:i:s', time() + 3600)
        ];
    }
    ...
    /**
     * Usar código PIX exato fornecido
     */
    private function generateSimulatedPixCode($amount, $payerName, $txid) {
        // Código PIX atualizado
        return '00020126460014BR.GOV.BCB.PIX0124restifyapp.dpo@gmail.com5204000053039865802BR5921LUCAS FERREIRA SANTOS6014BELO HORIZONTE62070503***6304CAC4';
    }
